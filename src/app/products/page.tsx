...
export const metadata: Metadata = {
  ...
  description:
    "Transform your GPS routes and favorite trails into beautiful 3D printed keepsakes. Route tiles, ornaments, pen holders, and custom prints available.",
  keywords: [
    "route tiles",
    "GPS route art",
...
const products = [
  ...
  },
  {
    ...
    description:
      "These ornaments feature your favorite GPS route in a compact, decorative form. Perfect for holiday trees, backpacks, or as a unique gift.",
    features: [
  ...
  },
  {
    ...
    description:
      "These ornaments feature the topographical profile of a given state. They look magnificent backlit on a Christmas tree or hanging in a window.",
    features: [
      "Premium white PLA plastic",
      "Stylistic ribbon for hanging",
  ...
  },
  {
    ...
    description:
      "Celebrate local peaks or your favorite mountain ridge with a custom 3D-printed mountain pen holder.",
    features: [
      "Premium PLA plastic construction",
  ...
  },
  {
    ...
    name: "Custom Prints",
    description:
      "Have a specific route, landmark, or design in mind? We can create custom 3D prints based on your GPS data or design ideas.",
    features: [
        ...
        <div className="bg-alpine-mist py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="mb-4">
                <span className="brand-mantra text-2xl md:text-3xl">
                  Get Out There
                </span>
              </div>
              ...
              <p className="mt-6 max-w-2xl mx-auto text-xl text-slate-storm">
                Transform your favorite outdoor memories into stunning 3D
                printed keepsakes. Each piece is custom-made to celebrate your
                unique adventures.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-20">
              {products.map((product, index) => (
                ...
                >
                  ...
                  {/* Product Details */}
                  <div
                    className={`mt-8 lg:mt-0 ${index % 2 === 1 ? "lg:col-start-1" : ""}`}
                  >
                    <h2 className="text-3xl font-headline font-bold text-basalt lg:text-4xl">
                      {product.name}
                    </h2>
                    ...
                    {/* Features */}
                    <div className="mt-6">
                      <h3 className="font-headline font-semibold text-basalt">
                        Features:
                      </h3>
                      ...
                      <div className="mt-6">
                        ...
                        <div className="mt-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {product.sizes.map((size, sizeIndex) => (
                            <div
                              key={sizeIndex}
                              className="bg-summit-sage/5 rounded-lg p-4 text-center"
                            >
                              <h4 className="font-headline font-semibold text-basalt">
                                {size.name}
                              </h4>
                              <p className="text-sm text-slate-storm">
                                {size.size}
                              </p>
                              <p className="text-lg font-headline font-bold text-summit-sage">
                                {size.price}
                              </p>
                            </div>
                          ))}
                        ...
                        {/* Color Options */}
                        <div className="mt-4">
                          <h4 className="font-headline font-semibold text-basalt text-sm">
                            Route Colors:
                          </h4>
                          <div className="mt-2 flex flex-wrap gap-2">
                            {product.colors.map((color, colorIndex) => (
                              <span
                                key={colorIndex}
                                className="bg-summit-sage/10 text-summit-sage px-3 py-1 rounded-full text-xs font-headline"
                              >
                                {color}
                              </span>
                            ))}
                    ...
                    {product.pricing && (
                      <div className="mt-6">
                        <span className="text-2xl font-headline font-bold text-summit-sage">
                          {product.pricing}
                        </span>
                      </div>
                    )}
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              <div className="text-center">
                ...
                <p className="mt-2 text-alpine-mist/90">
                  Send us a link to your Strava, Garmin Connect, or Komoot
                  activity, or email the .gpx file directly to
        ...
        <div className="bg-basalt py-16">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-lg text-alpine-mist/90">
              Don&rsquo;t let your most epic moments live only in your camera
              roll. Let&rsquo;s create something awesome together.
            </p>
