  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-secondary-50 relative overflow-hidden mountain-wireframe">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-r from-secondary-400 to-primary-400 rounded-full blur-xl"></div>
        <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-r from-accent-400 to-secondary-400 rounded-full blur-lg"></div>
        <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-gradient-to-r from-primary-400 to-accent-400 rounded-full blur-2xl"></div>
      </div>
